      ...
      for (int i = 0; i < this.board.length; i++) {
        for (int j = 0; j < this.board[0].length; j++) {
            ...
            if (this.board[i][j] != 0) {
              ...
              if (this.board[i][j] == 2) {
                g2.drawString("2", i * GameWindow.this.squaresize + GameWindow.this.squaresize / 4, (j + 1) * GameWindow.this.squaresize - GameWindow.this.squaresize / 6);
              } else if (this.board[i][j] == 4){
                g2.drawString("4", i * GameWindow.this.squaresize + GameWindow.this.squaresize / 4, (j + 1) * GameWindow.this.squaresize - GameWindow.this.squaresize / 6);
              } else {
                g2.drawString(Integer.toString(this.board[i][j]), i * GameWindow.this.squaresize + GameWindow.this.squaresize / 4, (j + 1) * GameWindow.this.squaresize - GameWindow.this.squaresize / 6);
              }
              g2.setColor(Color.LIGHT_GRAY);
            }
          }
